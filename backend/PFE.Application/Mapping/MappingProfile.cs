...
public class MappingProfile : Profile
{
    public MappingProfile()
    {
        ...
        CreateMap<Seat, SeatMapResponseDto>()
            .ForMember(dest => dest.OfficeTableName, opt => opt.MapFrom(src => src.OfficeTable.Name))
            .ForMember(dest => dest.IsReserved, opt => opt.Ignore()) // Will be set in service
            .ForMember(dest => dest.ReservedByUserId, opt => opt.Ignore()) // Will be set in service
            .ForMember(dest => dest.ReservedByUserName, opt => opt.Ignore()) // Will be set in service
            .ForMember(dest => dest.ReservationDate, opt => opt.Ignore()); // Will be set in service
...
CreateMap<CreateRoomReservationDto, RoomReservation>()
    ...
    .ForMember(dest => dest.User, opt => opt.Ignore());
        ...
        CreateMap<CreateEventDto, Event>()
            .ForMember(dest => dest.Id, opt => opt.Ignore())
            .ForMember(dest => dest.CreatedByUserId, opt => opt.Ignore()) // Will be set from authenticated user
            .ForMember(dest => dest.CreatedAt, opt => opt.MapFrom(src => DateTime.UtcNow))
            .ForMember(dest => dest.Room, opt => opt.Ignore())
